...
public class Database_Manager
{
    ...
    private const string connectionString = "Server=db4free.net;Port=3306;database=patoenti;Uid=jordi_tomas;password=patoenti;SSL Mode=None;connect timeout=3600;default command timeout = 3600;";
    ...
    //Log in con username y password
    ...
    //Sign in con username, password y raza
